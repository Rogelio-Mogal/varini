...
<div class="shadow-md rounded-lg p-4 dark:bg-gray-800">
    {{--
        <div class="flex items-center justify-between">
            <p class="text-2xl font-semibold leading-normal text-gray-900 dark:text-white">Permisos</p>
            <a href="{{ route('admin.permissions.create') }}"
                class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Nuevo</a>
        </div>
        --}}
...
<script>
    ...
    $(document).ready(function() {
        var permissionsTable = new DataTable('#permissions', {
            responsive: true,
            "language": {
        ...
        $('#permissions').on('click', '.delete-item', function(e) {
            e.preventDefault();
            var id = $(this).data('id');
