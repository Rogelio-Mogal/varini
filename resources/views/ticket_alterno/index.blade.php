                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if ($item->estado == 'CREADO' && $item->activo == 1)
                                    ...
                                    <a href="{{ route('admin.ticket.alterno.edit', $item->id) }}"
                                ...
                                @endif
                                <a href="{{ route('admin.ticket.alterno.destroy', $item->id) }}"
                                ...
                                <div id="listo{{ $item->id }}" role="tooltip"
                                    class="absolute z-10 invisible inline-block w-54 text-sm font-light text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400">
                                    <div class="p-2 space-y-2">
                                        <h6 class="font-semibold mb-0 text-gray-900 dark:text-black">Ticket listo</h6>
                                    </div>
                                </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#ticket').on('change', '.checkbox_check', function() {
            var id = $(this).val();
            if ($(this).is(':checked')) {
        ...
        $('#seleccionarTodo').on('click', function() {
            var checkboxInputs = $('#ticket tbody tr:visible input[type="checkbox"]');
        ...
        $(document).on('click', '#eliminaSeleccion', function(e) {
            ...
            if (cantidadSeleccionados > 0) {
                var elimina = '{{ route('admin.ticket.alterno.destroy', ':id') }}';
        ...
        $(document).on('click', '.listo-item', function(e) {
            ...
            Swal.fire({
                title: '¿El ticket alterno esta listo?',
                ...
                if (result.value) {
                    ...
                    var showUrl = "{{ route('admin.ticket.alterno.update', ':id') }}";
