...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#ponchados_pedidos tbody').on('click', '.open-modal', function() {
            var id = $(this).data('id');
            showModal(id);
        });
        ...
        // detalles
        $('#ponchados_pedidos tbody').on('click', 'tr', function () {
    ...
    function ponchados() {
        ...
        // Inicializar DataTable
        var table =  $('#ponchados_pedidos').DataTable({
            "language": {
                ...
                */
                {
                    ...
                    render: function(data, type, row) {
                        switch (data) {
                            case 'Diseño':
                                return '<span class="bg-yellow-100 text-yellow-800 text-sm font-medium px-2.5 py-0.5 rounded dark:bg-yellow-900 dark:text-yellow-300">Diseño</span>';
                            case 'Bordando':
                                return '<span class="bg-teal-100 text-teal-800 text-sm font-medium px-2.5 py-0.5 rounded dark:bg-teal-900 dark:text-teal-300">Bordando</span>';
                            case 'Finalizado':
                                return '<span class="bg-purple-100 text-purple-800 text-sm font-medium px-2.5 py-0.5 rounded dark:bg-purple-900 dark:text-purple-300">Finalizado</span>';
                            case 'Entregado':
                                return '<span class="bg-green-100 text-green-800 text-sm font-medium px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300">Entregado</span>';
                            case 'Eliminado':
                                return '<span class="bg-red-100 text-red-800 text-sm font-medium px-2.5 py-0.5 rounded dark:bg-red-900 dark:text-red-300">Eliminado</span>';
                            default:
                                return '<span class="bg-gray-100 text-gray-800 text-sm font-medium px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300">Desconocido</span>';
                        }
                    }
                },
                {
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        if (isActive == 1) {
                                ...
                                <a href="#"
                                    data-popover-target="estatus-${data}" data-popover-placement="left"
                                    data-id="${data}"
                                ...
                                <div id="estatus-${data}" role="tooltip"
                                    class="absolute z-10 invisible inline-block w-54 text-sm font-light text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400">
                                    <div class="p-2 space-y-2">
