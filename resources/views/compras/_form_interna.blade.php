...
<div class="grid lg:grid-cols-12 md:grid-cols-12 sm:grid-cols-12 gap-2">
    ...
    <div class="sm:col-span-12 lg:col-span-7 md:col-span-5">
    ...
    <script>
        ...
        $(document).ready(function() {
                    ...
                    $.ajax({
                        ...
                        success: async function(data) {
                            ...
                            if (data.length === 0) {
                                ...
                                html += '<tr>';
                                html += '<td style="width:120px;">';
                                html += '<input type="hidden" name="check_serie[]" value="'+isSerie+'" class="check_serie is_serie" />';
                                html +=
            ...
            $(document).on('keydown', '.serie', function(e) {
                if (e.which === 13) {
                    e.preventDefault(); // Evita el comportamiento por defecto de "Enter" (como el envío de formularios)
                    var textarea = $(this);
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.data.length === 0) {
                                ...
                                $("#producto_id").val(producto.id);  // Si "id" es el ID del producto
                                $("#producto").val(producto.nombre);  // Asumiendo que "nombre" es el nombre del producto
                                $('#producto_serie').val(producto.serie);  // Si "serie" es el número de serie del producto
