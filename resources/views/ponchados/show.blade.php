    ...
    <div class="shadow-md rounded-lg p-4 dark:bg-gray-800">
        <div class="grid lg:grid-cols-12 md:grid-cols-12 sm:grid-cols-12 gap-2">
            ...
            <div class="sm:col-span-12 lg:col-span-2 md:col-span-2">
                ...
                <p class="mb-3 text-lg text-gray-900 md:text-xl dark:text-gray-800">
                    {{ number_format($ponchado->puntadas, 2, '.', ',')   }}
                </p>
            </div>
            ...
            <div class="sm:col-span-12 lg:col-span-2 md:col-span-2">
                ...
                @if ($archivoUrl)
                    <a href="{{ route('ponchados.descargarArchivo', $ponchado->id) }}"
                        class="inline-flex items-center px-4 py-2 text-3xl font-medium text-gray-900 bg-white border border-gray-200 rounded-s-lg rounded-e-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-blue-500 dark:focus:text-white">
                ...
                @else
                    <p class="text-red-600 font-semibold text-3xl">Archivo no encontrado</p>
                @endif
            </div>
            ...
            <div class="sm:col-span-12 lg:col-span-4 md:col-span-4">
                <figure class="flex justify-center items-center w-full h-full">
                    <img class="object-cover object-center max-w-full max-h-full"
                        src="{{ $ponchado->imagen_1 ? asset('' . $ponchado->imagen_1) : '#' }}"
                        alt="" id="imgPreview1">
                </figure>
            </div>
                            ...
                            <div class="sm:col-span-12 lg:col-span-12 md:col-span-12">
                                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                                    <table id="item_table_{{ $index }}"
                                        class="w-full text-3xl text-left text-gray-900">

                                        <thead class="text-xs text-gray-900 uppercase bg-indigo-200">
                                            <tr>
                                                <th class="px-6 py-3 text-2xl font-extrabold dark:text-white">#</th>
                                                ...
                                                <th class="px-6 py-3 text-2xl font-extrabold dark:text-white">Otro</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @php $num = 1; @endphp
