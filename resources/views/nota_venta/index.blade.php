...
<div class="shadow-md rounded-lg p-4 dark:bg-gray-800">
    <div class="grid grid-cols-1 lg:grid-cols-12 md:grid-cols-12 sm:grid-cols-12 gap-4">
        <div class="sm:col-span-12 lg:col-span-12 md:col-span-12">
            <table id="nota_venta" class="table table-striped" style="width:100%">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Cliente</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="inline-flex rounded-md shadow-sm" role="group">
                                    <a href="{{ route('admin.nota.venta.show', $item->id) }}"
                                    ...
                                    @if ($item->activo == 1)
                                        <a href="{{ route('admin.nota.venta.destroy', $item->id) }}" data-id="{{ $item->id }}"
...
<script>
    $(document).ready(function() {
        var rolesTable = new DataTable('#nota_venta', {
            responsive: true,
            "language": {
        ...
        $('#nota_venta').on('click', '.delete-item', function(e) {
            e.preventDefault();
            var id = $(this).data('id');
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    var showUrl = "{{ route('admin.nota.venta.destroy', ':id') }}";
